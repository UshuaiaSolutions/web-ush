...
import IlustracionAbout from "../../assets/Ilustracion-About";
import OndasLargas from "../../assets/OndasLargas";
        ...
        <CardContainer className="mb-30">
            ...
            <SVGContainer className="mb-35 mb-16-mobile">
              ...
              >
                <path
                  ...
                  fill={
                    theme.nombre === "light" ? colors.azulush : colors.amarillo
                  }
                />
              </Experience>
            </SVGContainer>
          ...
          <Card>
            <SVGContainer className="mb-35 mb-16-mobile">
              ...
              >
                <path
                  d="M15.7835 17.9765C18.0632 17.9765 19.9113 16.1286 19.9113 13.849C19.9113 11.5695 18.0632 9.72156 15.7835 9.72156C13.5038 9.72156 11.6558 11.5695 11.6558 13.849C11.6558 16.1286 13.5038 17.9765 15.7835 17.9765Z"
                  fill={
                    theme.nombre === "light" ? colors.lilaush : colors.verdeush
                  }
                />
                <path
                  d="M42.2225 17.9765C44.5022 17.9765 46.3502 16.1286 46.3502 13.849C46.3502 11.5695 44.5022 9.72156 42.2225 9.72156C39.9428 9.72156 38.0947 11.5695 38.0947 13.849C38.0947 16.1286 39.9428 17.9765 42.2225 17.9765Z"
                  fill={
                    theme.nombre === "light" ? colors.lilaush : colors.verdeush
                  }
                />
                <path
                  d="M28.4433 7.93992C28.9808 7.84785 29.5332 7.96953 29.9822 8.27896C30.4313 8.5884 30.7415 9.06105 30.8469 9.5961C30.9305 10.0454 32.9786 20.4529 42.4202 20.4529H42.6554C52.9592 20.4529 57.1288 29.7476 57.9126 34.7633C58.0091 35.3032 57.8895 35.8593 57.5796 36.3118C57.2698 36.7644 56.7946 37.077 56.2563 37.1823C56.1325 37.2074 56.0063 37.2198 55.88 37.219C55.3888 37.2132 54.9152 37.0345 54.5426 36.7144C54.1699 36.3943 53.9221 35.9534 53.8423 35.4687C53.79 35.1395 52.8233 29.3297 48.5127 26.336C48.3977 26.2559 48.2631 26.2088 48.1233 26.1997C47.9836 26.1907 47.844 26.2201 47.7197 26.2847C47.5954 26.3493 47.4911 26.4465 47.4182 26.5661C47.3452 26.6856 47.3062 26.8227 47.3056 26.9628V35.6149H36.0249V24.0318C36.0237 23.7825 35.9557 23.5382 35.828 23.3241C35.7003 23.11 35.5174 22.9339 35.2986 22.8144C29.9691 19.8729 27.4351 13.9325 26.7819 10.338C26.6915 9.80052 26.8144 9.24891 27.1248 8.80092C27.4352 8.35293 27.9083 8.04409 28.4433 7.93992Z"
                  fill={
                    theme.nombre === "light" ? colors.lilaush : colors.verdeush
                  }
                />
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
                  d="M28.9994 7.91958C29.1833 7.90161 29.3703 7.90795 29.5555 7.93968C30.0896 8.04502 30.5614 8.35435 30.8707 8.80221C31.18 9.25006 31.3024 9.80103 31.2118 10.3377C31.1871 10.4694 31.16 10.6043 31.1303 10.742C30.9453 10.1044 30.8624 9.67912 30.8469 9.59586C30.7415 9.0608 30.4313 8.58815 29.9823 8.27872C29.6879 8.07591 29.3492 7.95376 28.9994 7.91958ZM26.8644 10.7564C26.0458 13.5686 23.2574 20.4526 15.5786 20.4526H15.3434C5.03448 20.4526 0.870304 29.7474 0.0865525 34.7631C-0.0101596 35.3022 0.108661 35.8576 0.417452 36.3101C0.726244 36.7625 1.20015 37.0756 1.73748 37.182C1.86309 37.2069 1.99085 37.2193 2.1189 37.2188C2.6101 37.213 3.08363 37.0342 3.45627 36.7141C3.82892 36.3941 4.07681 35.9531 4.1566 35.4684C4.20885 35.1393 5.17558 29.3295 9.48621 26.3357C9.60115 26.2557 9.73576 26.2085 9.87553 26.1995C10.0153 26.1905 10.1549 26.2199 10.2791 26.2845C10.4034 26.349 10.5077 26.4463 10.5807 26.5658C10.6537 26.6854 10.6926 26.8225 10.6932 26.9625V35.6146H21.9739V24.0316C21.974 23.782 22.0418 23.5372 22.1696 23.3229C22.2974 23.1086 22.4807 22.9328 22.7003 22.8142C25.5593 21.2362 27.6063 18.7953 28.9938 16.3164C27.8899 14.3495 27.2036 12.3588 26.8644 10.7564Z"
                  fill={
                    theme.nombre === "light" ? colors.lilaush : colors.verdeush
                  }
                />
                <g style={{ mixBlendMode: "multiply" }}>
                  <path
                    fillRule="evenodd"
                    clipRule="evenodd"
                    d="M31.1302 10.742C30.9452 10.1044 30.8622 9.6791 30.8468 9.59584C30.7414 9.06078 30.4312 8.58814 29.9821 8.2787C29.6878 8.07589 29.3491 7.95374 28.9993 7.91956C28.6495 7.95374 28.3108 8.07589 28.0165 8.2787C27.5674 8.58814 27.2572 9.06078 27.1519 9.59584C27.1363 9.67973 27.0522 10.1108 26.8643 10.7564C27.2035 12.3588 27.8898 14.3495 28.9937 16.3164C30.0979 14.3436 30.7845 12.3469 31.1302 10.742Z"
                    fill="#060045"
                  />
                </g>
                <path
                  d="M27.916 1.52919V3.96907C27.916 4.48846 28.337 4.90967 28.8564 4.90967H29.123C29.6424 4.90967 30.0634 4.48846 30.0634 3.96907V1.52919C30.0634 1.0098 29.6424 0.588852 29.123 0.588852H28.8564C28.337 0.588852 27.916 1.0098 27.916 1.52919Z"
                  fill={
                    theme.nombre === "light" ? colors.lilaush : colors.verdeush
                  }
                />
                <path
                  d="M34.6395 3.73501L32.9142 5.46027C32.5469 5.82753 32.5469 6.4232 32.9142 6.79047L33.1025 6.97879C33.4698 7.34606 34.0653 7.34588 34.4326 6.97861L36.158 5.25336C36.5253 4.88609 36.5253 4.29078 36.158 3.92352L35.9696 3.73519C35.6023 3.36792 35.0068 3.36774 34.6395 3.73501Z"
                  fill={
                    theme.nombre === "light" ? colors.lilaush : colors.verdeush
                  }
                />
                <path
                  d="M21.8221 5.25191L23.5474 6.97717C23.9147 7.34443 24.5103 7.34425 24.8775 6.97699L25.0659 6.78866C25.4332 6.4214 25.4332 5.82609 25.0659 5.45882L23.3405 3.73356C22.9732 3.3663 22.3777 3.36612 22.0104 3.73338L21.8221 3.92171C21.4548 4.28898 21.4548 4.88465 21.8221 5.25191Z"
                  fill={
                    theme.nombre === "light" ? colors.lilaush : colors.verdeush
                  }
                />
